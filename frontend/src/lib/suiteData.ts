...
export const sourceSystems = [
  { name: 'AILanguageTranslationOperationsAssistant', ownership: 'Projects source capabilities and workflows', coverage: ['Projects', 'Assets', 'Calendar'] },
  { name: 'AILanguageTranslationOperationsOperations', ownership: 'Assets source capabilities and workflows', coverage: ['Scripts', 'Approvals', 'Rights'] },
  { name: 'AILanguageTranslationOperationsAnalytics', ownership: 'Calendar source capabilities and workflows', coverage: ['Publishing', 'Campaigns', 'Exceptions'] },
  { name: 'AILanguageTranslationOperationsWorkflow', ownership: 'Scripts source capabilities and workflows', coverage: ['Performance', 'Analytics', 'Reports'] },
];
