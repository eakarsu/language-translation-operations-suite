export const AUTH_COOKIE = 'language_translation_operations_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@language-translation-operations.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@language-translation-operations.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@language-translation-operations.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
