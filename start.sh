...
PORT="${PORT:-5820}"
DB_NAME="${PGDATABASE:-language_translation_operations_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Language Translation Operations Suite"
echo "======================================="
echo
...
echo "Starting language translation operations suite frontend on http://localhost:$PORT"
echo "Login: admin@language-translation-operations.local / admin123"
